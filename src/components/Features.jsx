...
const FEATURES = [
  ...
  },
  {
    ...
    label: "E-commerce",
    title: "Online stores",
    text: "Product catalogs, cart and checkout, and admin dashboards for businesses that want to sell online.",
  },
  {
    n: "04",
    label: "Business sites",
    title: "Restaurant & business websites",
    text: "Booking, ordering and business websites for cafes, restaurants and local businesses.",
  },
  {
    n: "05",
    label: "Real estate",
    title: "Real estate platforms",
    text: "Property listing and management platforms with search, filters and an admin panel for agents.",
  },
  {
    n: "06",
    label: "Support",
